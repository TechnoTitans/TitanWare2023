            ...
            new TitanCameraCalibration()
                    .withCalibrations(
                            ...
                            Matrix.mat(Nat.N3(), Nat.N3())
                                    .fill(
                                            736.3115097950308, 0.0, 682.0845767503529,
                                            0.0, 734.5292580632072, 446.8962407693138,
                                            0.0, 0.0, 1.0
                                    ),
                            VecBuilder.fill(
                                    0.15397416138064096,
    ...
    PHOTON_FR_Apriltag_R(
            ...
            new TitanCameraCalibration()
                    ...
                    .withCalibrations(
                            ...
                            Matrix.mat(Nat.N3(), Nat.N3())
                                    .fill(
                                            903.5836779451547, 0.0, 638.7675280266341,
                                            0.0, 900.9540830228923, 387.9223738303693,
                                            0.0, 0.0, 1.0
                                    ),
                            VecBuilder.fill(
                                    0.035054227597273384,
                                    -0.03822376457446286,
                                    0.0031090657413862764,
                                    -0.0031253848722210837,
                                    -0.024314725609670615
                            ),
                            List.of(
                                    0.2273379456568952,
                                    0.09973719269174569,
